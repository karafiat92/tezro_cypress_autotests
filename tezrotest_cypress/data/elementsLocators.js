...
locators = [
    ...
    signUpLocators = {
        startPage: { // стартовая страница
            sugnInButton: "#loginButton",
            sugnUpButton: "#signupButton"
        },
        ...
        signUp2Step: { // вторая страница (заполнение данных профиля)
            firstNameInput: "input#firstNameField",
            lastNameInput: "input#lastNameField",
            //phoneNumberInput: "input#phoneField",
            usernameInput: "input#usernameField",
            //countryButton: "#countryButton",
            //chooseCountryButton: ".countryItem",
            nextButton: "#signUpSecondSubmit",
            //searchCountryInput: "#countrySearch",
